...
export const STRINGS = {
  ...
  'adv.mirrorless':   { zh: 'Mirrorless 部署（冗余由存储层提供）', en: 'Mirrorless deployment (redundancy at the storage layer)' },
  'adv.mirrorless.hint': { zh: '适用于云盘 / vSAN 等多副本存储：不部署 mirror，可用容量近乎翻倍。注意：当前开源 Cloudberry 尚不支持 mirrorless，需联系 Cloudberry 商业支持厂商适配，或自行适配相关平台能力；本地盘方案不适用', en: 'For replicated storage (managed cloud disks / vSAN): skips segment mirrors, usable capacity nearly doubles. Note: open-source Cloudberry does not support mirrorless out of the box — engage a commercial Cloudberry support vendor or adapt the platform capability yourself; not applicable to local-disk schemes' },
